    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      <div className="w-full max-w-md rounded-2xl border border-[var(--color-border)] bg-[var(--card)] p-6 shadow-2xl space-y-4">
        ...
        <div className="space-y-3 text-xs">
          <div>
            <label className="font-semibold text-[var(--text-secondary)]">{t('inventory.form.ingredientName')}</label>
            <input
              type="text"
              value={ingName}
          ...
          <div>
            <label className="font-semibold text-[var(--text-secondary)]">{t('inventory.form.category')}</label>
            <select
              value={ingCategory}
          ...
          <div>
            <label className="font-semibold text-[var(--text-secondary)]">{t('inventory.form.supplier')}</label>
            <input
              type="text"
              value={ingSupplier}
          ...
          <div>
            <label className="font-semibold text-[var(--text-secondary)]">{t('inventory.form.currentStock')}</label>
            <input
              type="text"
              value={ingStock}
